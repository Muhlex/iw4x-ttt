...
setHeadIcon( showTo, icon, offset, width, height, waypointConstantSize, waypointOffscreen )
{
	...
	if (!isDefined(waypointConstantSize)) waypointConstantSize = true;
	if (!isDefined(waypointOffscreen)) waypointOffscreen = true;

	headIcon setWaypoint( waypointConstantSize, waypointOffscreen );
